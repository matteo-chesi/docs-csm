...
1. [Configure Keycloak Account](../install/configure_administrative_access.md#configure-keycloak-account)
1. [Configure the Cray Command Line Interface (CLI)](../install/configure_administrative_access.md#configure-the-cray-command-line-interface-cray-cli)
